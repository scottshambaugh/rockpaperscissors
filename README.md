...
Each fairness cell is `total(twin-free)` — the total count up to isomorphism, with the twin-free subcount in parentheses. The `candidates` column is the raw brute-force search space, `3^(n choose 2)` (one of `{-1, 0, +1}` per upper-triangle edge), before any filtering or isomorphism reduction.

| n | candidates = 3^C(n,2) | two-paradox | regular  | balanced  | inclusive  |
|---|-----------------------|-------------|----------|-----------|------------|
| 3 | 27                    | 0 (0)       | 1 (1)    | 1 (1)     | 1 (1)      |
| 4 | 729                   | 0 (0)       | 1 (1)    | 1 (1)     | 3 (2)      |
| 5 | 59,049                | 0 (0)       | 2 (2)    | 4 (3)     | 15 (8)     |
| 6 | 14,348,907            | 0 (0)       | 5 (4)    | 16 (13)   | 222 (177)  |
| 7 | 10,460,353,203        | 1 (1)       | 13 (12)  | 175 (152) | —          |
| 8 | 22,876,792,454,961    | 0 (0)       | 82 (76)  | —         | —          |
